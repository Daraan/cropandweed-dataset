...
DATASETS["Maize2"] = Dataset(
    {0: ("Maize", (255, 0, 0), [1, 2, 3, 4, 5, 6]), 1: ("Other", (128, 255, 192), [*range(7, 100)])}
)

DATASETS["Maize1"] = Dataset({0: ("Maize", (255, 0, 0), [1, 2, 3, 4, 5, 6])})
...
DATASETS["SugarBeet1"] = Dataset({0: ("Sugar beet", (255, 85, 0), [7, 8, 9, 10, 11, 12])})

DATASETS["Soy2"] = Dataset(
    {0: ("Soy", (42, 255, 0), [94]), 1: ("Other", (128, 255, 192), [*range(1, 94)] + [*range(95, 100)])}
)

DATASETS["Soy1"] = Dataset({0: ("Soy", (42, 255, 0), [94])})

DATASETS["Sunflower2"] = Dataset(
    {0: ("Sunflower", (85, 0, 255), [24]), 1: ("Other", (128, 255, 192), [*range(1, 24)] + [*range(25, 100)])}
)

DATASETS["Sunflower1"] = Dataset({0: ("Sunflower", (85, 0, 255), [24])})

DATASETS["Potato2"] = Dataset(
    {0: ("Potato", (0, 255, 85), [18]), 1: ("Other", (128, 255, 192), [*range(1, 18)] + [*range(19, 100)])}
)

DATASETS["Potato1"] = Dataset({0: ("Potato", (0, 255, 85), [18])})

DATASETS["Pea2"] = Dataset(
    {0: ("Pea", (255, 170, 0), [13]), 1: ("Other", (128, 255, 192), [*range(1, 13)] + [*range(14, 100)])}
)

DATASETS["Pea1"] = Dataset({0: ("Pea", (255, 170, 0), [13])})

DATASETS["Bean2"] = Dataset(
    {0: ("Bean", (255, 0, 170), [26, 27]), 1: ("Other", (128, 255, 192), [*range(1, 26)] + [*range(28, 100)])}
)

DATASETS["Bean1"] = Dataset({0: ("Bean", (255, 0, 170), [26, 27])})

DATASETS["Pumpkin2"] = Dataset(
    {0: ("Pumpkin", (170, 255, 0), [15]), 1: ("Other", (128, 255, 192), [*range(1, 15)] + [*range(16, 100)])}
)

DATASETS["Pumpkin1"] = Dataset({0: ("Pumpkin", (170, 255, 0), [15])})
